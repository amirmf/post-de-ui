...
const NotedeliverModify = () => {
  ...
  const onSubmitHandler = (submission: any) => {
    ...
    setSubmitted(true);
    Swal.fire({
      title: "<div style='font-size:22px;'><b>Successfully submited.</b></div>",
      icon: "success",
  ...
  return (
    <>
      <div>
        <Form src="https://formio.nachsendeauftrag-buchen.de/notedelivermodify" onSubmit={onSubmitHandler} submission={loadData} options={{
          language: 'de',
          i18n: {
            de: de
          }
...
export default NotedeliverModify;
